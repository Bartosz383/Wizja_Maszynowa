...
start_button = tk.Button(frame1, text="Laboratoria 1", command=start_program, width=20, height=2)
...
exit_button = tk.Button(frame2, text="Wyjście", command=app.quit, width=20, height=2)
...
info_label2 = tk.Label(frame2, text="Zamyka program")
